...
<body class="g-sidenav-show bg-gray-100">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0" style="font-size: 30px;">Hatch Data</h6>
          <p class="text-white mb-0">Hatching data is data that contains information about the eggs that are put into the incubator</p>
        </nav>
      </div>
            ...
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <form action="inputdata.php" style="text-align: center;">
                  <button type="submit" class="btn bg-gradient-warning w-100" href="inputdata.php">
                ...
                <table class="table align-items-center text-center mb-0">
                  <thead style="position: sticky; top: 0; background-Color:#ffffff;">
                    <tr>
                      ...
                      <th class="text-uppercase">Hatching Eggs</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <?php echo $row['KET_MENETAS']; ?>
                      </td>
                      <td>
                        <a href="editdata.php?id=<?php echo $row['ID_KLOTER'];?>" class="text-warning">
                          <i class="fa fa-pen me-sm-1"></i>
                        </a>
                      </td>
                      <td>
                        <a href="proseshapusdata.php?id=<?php echo $row['ID_KLOTER'];?>" class="text-warning">
  ...
  <script>
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM penetasan WHERE ID_PETERNAK = $ID_PETERNAK ORDER BY NO_KLOTER DESC LIMIT 10");
    while ($row = mysqli_fetch_assoc($result)) {
      $dataTelurPerKloter[] = $row['JMLH_TELUR'];
      $telurMenetas[] = $row['KET_MENETAS'];
      ...
      data: {
        ...
        datasets: [
          ...
          },
          {
            ...
            borderWidth: 2,
            fill: true,
            data: <?php echo json_encode($telurMenetas); ?>,
          },
        ],
      },
      options: {
